...
public class Mediator {
    ...
    private final JLabel stunLabel;
    ...
    public Mediator(JLabel enemyHealthLabel, JLabel playerHealthLabel, JDialog endFightDialog, JLabel pointsValueLabel, JLabel experienceValueLabel,
            ...
            JDialog cantUseItemDialog, JDialog itemsBagDialog, JLabel GIFLabel, JLabel stunLabel) {
    ...
    public void setNewRoundTexts(Player player, Enemy enemy, Item[] items){
        ...
        setBagText(items);
        enemyLevelLabel.setText(enemy.getName() + " (" + enemy.getType() + ")");
    }
    ...
    public void setStunLabel(Fighter fighter) {
        if (fighter != null && fighter.isStunned()) {
            stunLabel.setText(fighter.getName() + " оглушён!");
        } else {
            stunLabel.setText("");
        }
    }
